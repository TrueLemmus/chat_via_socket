...
from common.variables import ACCOUNT_NAME, ACTION, ADD_CONTACT, DATA, ERROR, EXIT, GET_CONTACTS, LIST_INFO, \
    MAX_CONNECTIONS, DESTINATION, MESSAGE, MESSAGE_TEXT, PRESENCE, PUBLIC_KEY, PUBLIC_KEY_REQUEST, REMOVE_CONTACT, \
    RESPONSE, RESPONSE_200, RESPONSE_202, RESPONSE_205, RESPONSE_400, RESPONSE_511, SENDER, TIME, USER, USERS_REQUEST
